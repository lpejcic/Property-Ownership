...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "You must be owner");
        _;
    }
    //  4) fill out the transferOwnership function
        ...
        require(newOwner != address(0x0), "Address provided is not valid");
        _owner = newOwner;
        emit ownerShip(_owner);
...
contract Pausable is Ownable {
    ...
    function setPaused(bool state) public onlyOwner {
        require(_paused != state, "Contract is already in that state");
        _paused = state;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(tokenOwner != to, "Token already owned by given address");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "Must be owner or have been approved");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(address(0x0) != to, "Address not valid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Address is not the owner");
        // TODO: require token is being transfered to valid address
        require(address(0x0) != to, "Reciever address is not valid");
        // TODO: clear approval
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        string memory newTokenURI = strConcat(_baseTokenURI, uint2str(tokenId));
...
contract CustomERC721Token is ERC721Metadata("CapstoneToken", "CAT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
